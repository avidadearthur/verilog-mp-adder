...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NBYTES_MUL" -parent ${Page_0}
  ipgui::add_param $IPINST -name "OPERAND_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "OPERAND_WIDTH_MUL" -parent ${Page_0}
...
proc update_PARAM_VALUE.NBYTES_MUL { PARAM_VALUE.NBYTES_MUL } {
	# Procedure called to update NBYTES_MUL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NBYTES_MUL { PARAM_VALUE.NBYTES_MUL } {
	# Procedure called to validate NBYTES_MUL
	return true
}
...
proc update_PARAM_VALUE.OPERAND_WIDTH_MUL { PARAM_VALUE.OPERAND_WIDTH_MUL } {
	# Procedure called to update OPERAND_WIDTH_MUL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OPERAND_WIDTH_MUL { PARAM_VALUE.OPERAND_WIDTH_MUL } {
	# Procedure called to validate OPERAND_WIDTH_MUL
	return true
}
...
proc update_MODELPARAM_VALUE.OPERAND_WIDTH_MUL { MODELPARAM_VALUE.OPERAND_WIDTH_MUL PARAM_VALUE.OPERAND_WIDTH_MUL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OPERAND_WIDTH_MUL}] ${MODELPARAM_VALUE.OPERAND_WIDTH_MUL}
}
...
proc update_MODELPARAM_VALUE.NBYTES_MUL { MODELPARAM_VALUE.NBYTES_MUL PARAM_VALUE.NBYTES_MUL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NBYTES_MUL}] ${MODELPARAM_VALUE.NBYTES_MUL}
}
